...
#output_data.write_components(date, TV04, TV05,          # Вносим кол-во израсходованных компонентов в таблицу 'components'
#TV04_composition, TV05_composition) 
...
## Пример вызова функции расчёта баланса деталей
#part = input('Введите типоразмер (напр. C10, D20, XS16 и т.д.): ')
#print('Деталей ' + part + ':',  summary.balance(part))


## Вызов функции инвентаризации
#inventory.to_inventory()

## Пример вызова функции расчёта расхода смеси (для TV04)
#print(balance.parts_balance('C10'))

print(balance.component_balance('TV04'))